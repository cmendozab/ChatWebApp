(function () {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyCbgO6E3xarbKUoK7GJ_n9g_p26Dz_kYkA",
    authDomain: "chatapplicationcmb.firebaseapp.com",
    databaseURL: "https://chatapplicationcmb-default-rtdb.firebaseio.com",
    projectId: "chatapplicationcmb",
    storageBucket: "chatapplicationcmb.appspot.com",
    messagingSenderId: "155218381626",
    appId: "1:155218381626:web:0ef9f00d6dd01f18b0de03"
  };
  // Initialize Firebase
  ...
  // TODO: in this function you should set the userNameDisplay.innerHTML to the passed in userEmail as well as updating the currentUserEmail 
  //variable to that same value
  function updateCurrentUser(userEmail) {
      userNameDisplay.innerHTML = email.value; //CMB
      currentUserEmail = email.value; //CMB
      console.log(userNameDisplay); //CMB
      console.log(currentUserEmail); //CMB
